...
<body>
 ...
 <!-- Bootstrap row and col -->
  <div class="container-fluid">
    <div class="row ">
      <div class="col-3 bg-primary border  mw-100" style="height: 650px; position: fixed;">
          ...
          <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link text-hid" href="#"> <i class="fa fa-graduation-cap mr-2 "></i>Nos apprenants</a>
                </li>
            
            </ul>
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                <a class="nav-link text-hiden" href="#"> <i class="fa fa-user mr-2"></i></i>Admin</a>
              </li>
            </div>
        </div>
        </ul>
              
          <h2 class="text-center">Modification d'un apprenant</h2>
              ...
              <!-- bouton-->
               <div class="row">
                 ...
                 <div class="col-sm-6">
                  <button type="button" class="btn btn-block bg-secondary" style="width: 150px;">Annuler</button>
                </div>
              </div>
